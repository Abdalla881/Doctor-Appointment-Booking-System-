    ...
    <div className="px-6 md:px-12 lg:px-20 py-14 bg-gray-50">
      ...
      <div className="my-14 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-3/5 text-[16px] text-gray-700 leading-relaxed">
          <p className="text-lg">
            Welcome to{" "}
            <span className="font-semibold text-gray-900">Tabebak</span>, your
            trusted partner in managing your healthcare needs with ease and
            efficiency. At Tabebak, we understand the challenges individuals
            face when booking medical appointments and keeping track of their
            health records.
          </p>
          <b className="text-gray-900 text-xl">Our Vision</b>
          <p className="text-lg">
            Our vision at{" "}
            <span className="font-semibold text-gray-900">Tabebak</span> is to
            create a seamless healthcare experience for every user. We aim to
            bridge the gap between patients and healthcare providers, making it
